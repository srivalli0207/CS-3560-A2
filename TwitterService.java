...
public class TwitterService 
{
    ...
    public void addUserToGroup(String groupId) 
    {
        if (!groups.containsKey(groupId)) 
        {
            ...
            // Assuming you want to add the new group to the Root group by default
    ...
    public int getTotalTweets() 
    {
        ...
        {
            total += user.getTweetCount(); // Sum up tweet counts from all users
        }
        return total;
    }
    ...
    public double getPositiveTweetPercentage() 
    {
        ...
        return (double) positiveCount / totalTweets * 100.0;
    }

    private boolean isTweetPositive(String tweet) 
    {
        // Simple positive word check (customize as needed)
